...
The below diagrams detail the _operation_ workflow of our smart contracts. Live examples of our contracts can viewed at the following addresses
...
## Creation
1) Puzzle Author encrypts the puzzle answers locally using the `blake2b` npm package
2) The rewards hash is generated by encrypting the answers multiple times:
  ...
  - This is a publicly verifiable hash that can be checked by players calling the _Hashing Contract_ for free
