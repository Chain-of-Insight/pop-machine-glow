...
# None claimable
ligo dry-run oracle.ligo --syntax pascaligo main 'Solve(record [ id = 1583093350498n; proof = 0x7b15bb3dee5f8891f60cd181ff424012548a9ed5e26721eb9f6518e9dd409d9e ])' 'map [
    1583093350498n -> record [
            id = 1583093350498n;
            author = "tz1cmWyycuCBdHVHVCnXbRLdKfjNSesRPJyz";
            rewards_h = 0x7b15bb3dee5f8891f60cd181ff424012548a9ed5e26721eb9f6518e9dd409d9e;
